    ...
    <v-layout row wrap grid-list-xs text-xs-center>
      <v-flex xs8>
        <v-expansion-panel class="p-3" :expand="true">
          <v-expansion-panel-content v-for="(item, index) in deviceTypesProperties" :key="index">
        ...
        <div class="property newDevice">
          ...
          >
            <div class="list-group-item item" v-for="(element, index) in properties" :key="index">
              <v-layout row wrap justify-center>
                <p class="text-center">
                  {{ element.nameProperty }}
                  <span v-if="element.required" class="required">*</span>
                </p>
                <a @click="openModal(element.localID, element.type)" class="text-right">
              ...
              <v-layout row wrap justify-center>
                ...
                <a class="text-right" color="red" @click="deleteProperty(element.localID)">X</a>
              </v-layout>
            </div>
          </draggable>
        </div>
